...
using AdminIdentityserver.STS.Identity.Configuration;
using AdminIdentityserver.STS.Identity.Configuration.ApplicationParts;
using AdminIdentityserver.STS.Identity.Configuration.Constants;
using AdminIdentityserver.STS.Identity.Configuration.Interfaces;
using AdminIdentityserver.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace AdminIdentityserver.STS.Identity.Helpers
{
