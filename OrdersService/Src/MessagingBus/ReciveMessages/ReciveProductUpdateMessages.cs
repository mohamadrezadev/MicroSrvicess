...
{
    public class ReciveProductUpdateMessages : BackgroundService
    {
        ...
        public ReciveProductUpdateMessages(IOptions<RabbitMqConfiguration> options, IProductService productService)
        {
        ...
        {
            return productService.UpdateProduct(message.ProductId, message.NewName);
        }
    }
